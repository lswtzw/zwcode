...
{
    //static char *label_images = "C:/TDDownload/VOCtrainval_06-Nov-2007/VOCdevkit/VOC2007/SegmentationClass/";
    //static char *train_images = "C:/TDDownload/VOCtrainval_06-Nov-2007/VOCdevkit/VOC2007/JPEGImages/";

    static char *label_images = "C:/unet_data/train/label/";
    static char *train_images = "C:/unet_data/train/image/";
    ...
    for (i = 0; i < n; ++i) {
        ...
        //image orig = load_image_gray(train_img, 0, 0);
        //image label = load_image_gray(label_img, 0, 0);
