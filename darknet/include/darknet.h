...
typedef enum {
    CONVOLUTIONAL,
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    DECONVOLUTIONAL, //!!!!!*****这个暂时要死机,不能用,现在只能用 "上采样+卷积"两个层来代换它.!!!!!*****
	///////////////////////////////////////////////////////////////////////////////////////////////////
    CONNECTED,
    MAXPOOL,
    SOFTMAX,
...
//zw add fro unet #flag#
typedef struct tag_zwdatafile_nr {
	char backup_directory[256];
	char train_list_file[256];
	char train_image_path[256];
	char train_label_image_path[256];
	char image_file_type_hz[8];
	char test_image_path[256];
	int test_start_num;
	int test_end_num;
}ZWDATAFILE, *LPZWDATAFILE;
//zw add fro unet #flag#

// data.h
typedef enum {
    CLASSIFICATION_DATA, DETECTION_DATA, CAPTCHA_DATA, REGION_DATA, IMAGE_DATA, COMPARE_DATA, WRITING_DATA, SWAG_DATA, TAG_DATA, OLD_CLASSIFICATION_DATA, STUDY_DATA, DET_DATA, SUPER_DATA, LETTERBOX_DATA, REGRESSION_DATA, SEGMENTATION_DATA, INSTANCE_DATA, ISEG_DATA,UNET_DATA  //zwadd #flag# for mseg.c add UNET_DATA
} data_type;
...
LIB_API image get_network_image(network net);
...
LIB_API image load_image_gray(char *filename, int w, int h);
